export const modules = [
  ...
  ['paginas','paginas_publicas','Páginas del sitio','web','Comunicación'],
  ['contactos','mensajes_contacto','Mensajes recibidos','contact_mail','Comunicación'],
  ['plantillas-correo','plantillas_correo','Plantillas de correo','mail','Comunicación'],
